    ...
    constructor(props) {
        ...
        this.state = {
            contactData: [
                ...
                { name: '용산구', Latitude: 37.5305001, longtitude: 126.9109271,radius : 2 },
                { name: '성동구', Latitude: 37.5508716, longtitude: 127.0057898,radius : 3 },
                { name: '광진구', Latitude: 37.5462664, longtitude: 127.0507653,radius : 2 },
                { name: '동대문구', Latitude: 37.5835703, longtitude: 127.0154474, radius : 22 },
                { name: '중랑구', Latitude: 37.5950445, longtitude: 127.0606008, radius : 5 },
                { name: '성북구', Latitude: 37.6023087, longtitude: 126.9550242, radius : 9 },
                { name: '강북구', Latitude: 37.6482078, longtitude: 126.9813015, radius : 5 },
                { name: '노원구', Latitude: 37.6541905, longitude: 127.0419498, radius : 15 },
                { name: '도봉구', Latitude: 37.6662274, longitude: 126.994853, radius : 2 },
                { name: '은평구', Latitude: 37.6662274, longitude: 126.994853, radius : 17 },
                { name: '서대문구', Latitude: 37.5833748, longitude: 126.9006405, radius : 6 },
                { name: '마포구', Latitude: 37.5616592, longitude: 126.8736234, radius : 8 },
                { name: '양천구', Latitude: 37.5274949, longitude: 126.8208588, radius : 14 },
                { name: '강서구', Latitude: 37.5674043, longitude: 126.7533699, radius : 14 },
                { name: '구로구', Latitude: 37.495828, longitude: 126.8228501, radius : 20 },
                { name: '금천구', Latitude: 37.4600526, longitude: 126.8662469, radius : 5 },
                { name: '영등포구', Latitude: 37.5208971, longitude: 126.8783065, radius : 12 },
                { name: '동작구', Latitude: 37.4971749, longitude: 126.9093583, radius : 6 },
                { name: '관악구', Latitude: 37.4655159, longitude: 126.9092282, radius : 15 },
                { name: '서초구', Latitude: 37.4761416, longitude: 126.9671612, radius : 9 },
                { name: '강남구', Latitude: 37.496828, longitude: 126.9977276, radius : 14 },
                { name: '송파구', Latitude: 37.5047202, longitude: 127.0442531, radius : 15 },
                { name: '강동구', Latitude: 37.5492786, longitude: 127.0762157, radius : 5 }
            ]
        };
    }
